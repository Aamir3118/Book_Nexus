...
import com.example.books_app.databinding.FragmentSelectAccountBinding

/**
 * A simple [Fragment] subclass.
 * Use the [SelectAccountFragment.newInstance] factory method to
...
class SelectAccountFragment : BaseFragment() {
    ...
    private var binding: FragmentSelectAccountBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.frame47?.setOnClickListener {
            navigateToFragment(R.id.action_selectAccountFragment_to_addPaymentFragment)
        }
    }
}